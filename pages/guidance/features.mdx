...
You can define your own container environments 
in (`/src/components/AdmontionStyles.ts`). Make 
sure to also update `/src/plugins/remarkAdmonition.mjs` 
to ensure that your environments are recognised.
:::
```

:::tip[Custom container]
You can define your own container environments in (`/src/components/AdmontionStyles.ts`). Make sure to also 
update `/src/plugins/remarkAdmonition.mjs` to ensure that your environments are recognised.
:::
